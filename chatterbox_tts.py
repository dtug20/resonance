...
# curl -X POST "https://dtug20--chatterbox-tts-chatterbox-serve.modal.run/generate" \
#   -H "Content-Type: application/json" \
#   -H "X-Api-Key: super-secret-key" \
#   -d '{"prompt": "Hello from Chatterbox [chuckle].", "voice_key": "voices/system/cmopzhaki0001hqmnjvo18bpe"}' \
#   --output output.wav

# R2 cloud bucket mount (read-only, replaces Modal Volume)
R2_BUCKET_NAME = "resonance-app"
R2_ACCOUNT_ID = "25aaafa487f9c71dd9d5d4a727054ba5"
R2_MOUNT_PATH = "/r2"
