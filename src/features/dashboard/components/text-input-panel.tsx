...
import { TEXT_MAX_LENGTH, COST_PER_UNIT } from "../../text-to-speech/data/constants";
...
export function TextInputPanel() {
    ...
    return (
        <div className="
            rounded-[22px] bg-linear-185 from-[#ff8ee3] from-15% via-[#57d7e0] via-39% to-[#dbf1f2] to-85% shadow-[0_0_0_4px_white] px-[3px] py-[3px]
        ">
                    ...
                    <div className="flex items-center justify-between">
                        <Badge variant="outline" className="gap-1.5 border-dashed">
                            ...
                            <span className="text-xs text-chart-5">
                                {text.length === 0 ? (
                                    "Start typing to estimate characters"
                                ) : (
                                    <>
